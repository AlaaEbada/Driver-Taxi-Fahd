...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden hardware-accelerated">
      ...
      {/* Content */}
      <div className="relative z-10 container-luxury text-center px-4 flex-1 flex flex-col justify-center">
        <m.div
          initial="hidden"
          animate="visible"
          variants={{
        ...
        >
          ...
          <m.p
            ...
            className="text-base sm:text-xl md:text-2xl text-white/80 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed"
          >
            {t('hero.subtitle')}
          </m.p>
